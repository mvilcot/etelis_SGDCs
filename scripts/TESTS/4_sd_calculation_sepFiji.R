...
PAsite <- readRDS("intermediate/TEST/PA_Mat_GaspObis_site_sepFiji.RDS")
PAall <- readRDS("intermediate/TEST/PA_Mat_GaspObis_allstations_sepFiji.RDS")
...
## ---- export ----
write.csv(sd_global, paste0("results/TEST/sd_table_global_", comm_delin, "_sepFiji.csv"), row.names = FALSE)
write.csv(sd_alpha_site, paste0("results/TEST/sd_table_site_", comm_delin, "_sepFiji.csv"), row.names = FALSE)
write.csv(sd_alpha_station, paste0("results/TEST/sd_table_station_", comm_delin, "_sepFiji.csv"), row.names = FALSE)
saveRDS(list_sd_beta_site_pair, paste0("results/TEST/sd_list_pairwise_site_", comm_delin, "_sepFiji.RDS"))
saveRDS(list_sd_beta_station_pair, paste0("results/TEST/sd_list_pairwise_station_", comm_delin, "_sepFiji.RDS"))
