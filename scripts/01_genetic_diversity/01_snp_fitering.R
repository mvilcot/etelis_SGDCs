...
DART %>% 
  write.table("intermediate/Report_DEtel22-6705_SNP_2_ordered.csv",
...
gl <- 
  gl.read.dart(filename = "intermediate/01_genetic_diversity/Report_DEtel22-6705_SNP_2_ordered.csv",
...
gl <- 
  readRDS(file = "intermediate/01_genetic_diversity/Genlight_Etelis_coruscans_ordered.RDS")
...
gl1 <- 
  gl %>% 
  gl.drop.ind(c("ECO0934", "ECO0910", "ECO0912", "ECO0534", "ECO0535"), 
                   recalc = F, mono.rm = T) 
gl1
